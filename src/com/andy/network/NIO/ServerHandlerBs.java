...
public class ServerHandlerBs implements MessageHandle {

    private int bufferSize = 1024;
    private String localCharset = "UTF-8";

    public ServerHandlerBs() {
    }

    public ServerHandlerBs(int bufferSize) {
        this(bufferSize, null);
    }

    public ServerHandlerBs(String localCharset) {
        this(-1, localCharset);
    }

    public ServerHandlerBs(int bufferSize, String localCharset) {
